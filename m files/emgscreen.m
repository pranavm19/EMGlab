...
function emgscreen2 (opt, p1, p2)
   ...
   %         emgscreen ('draw'); %%%%%%%
    ...
    % Info Line
		...
		SCREEN.info.variance = uicontrol ('style', 'text', 'tag', 'variance explained', 'string', ' ', ...
			'pos', [x3-popup_width-small_gap, y4, popup_width, button_height], ...
			'hor', 'c', 'back', C.background, 'fore', C.backgr_text);
